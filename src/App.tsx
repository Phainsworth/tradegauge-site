...
{/* Watch-outs */}
<div className="rounded-2xl ring-1 ring-red-400/70 shadow-[0_0_28px_-12px_rgba(248,113,113,0.55)] overflow-hidden h-full">
  <div className="p-5 md:p-6 bg-neutral-950/90 backdrop-blur-sm h-full flex flex-col">
...
<img
  ...
  aria-hidden="true"
  className="
    absolute right-[-6vw] top-1/2 -translate-y-1/2
    h-[100vh] w-auto
    opacity-15
    mix-blend-soft-light
    pointer-events-none select-none
